  ...
  <div id="page-top">
    <div id="wrapper">
      ...
      <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <NuxtLink class="collapse-item" to="/admin/Vancancy">Detail</NuxtLink>
              <NuxtLink class="collapse-item" to="/admin/Vancancy/create">Create</NuxtLink>
            </div>
          </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseApplicant"
             aria-expanded="true" aria-controls="collapseApplicant">
  ...
  head() {
    return {
      ...
      link: [
        ...
        {rel: 'stylesheet', href: '/css/ruang-admin.min.css'},
      ],
      script: [
        {hid: 'stripe', src: '/vendor/jquery/jquery.min.js', defer: true},
        {hid: 'stripe', src: '/vendor/bootstrap/js/bootstrap.bundle.min.js', defer: true},
        {hid: 'stripe', src: '/vendor/jquery-easing/jquery.easing.min.js', defer: true},
