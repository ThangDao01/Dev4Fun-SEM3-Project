...
namespace Dev4Fun_Sem3_eProject.Data
{
    public class Dev4Fun_Sem3_eProjectContext : DbContext
    {
        ...
        public DbSet<Dev4Fun_Sem3_eProject.Models.AppliedJob> AppliedJob { get; set; }

        public DbSet<Dev4Fun_Sem3_eProject.Models.CurrentAccount> CurrentAccount { get; set; }
